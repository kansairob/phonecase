        ...
        <div className="relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20">
            ...
            <div className="h-[37.5rem] w-full col-span-full lg:col-span-1 flex flex-col bg-white">
                <ScrollArea className="flex-1 overflow-auto">
                    <div
                        aria-hidden="true" className="absolute z-10 inset-x-0 bottom-0
                                                ...
                                                {selectableOptions.map((option) => (
                                                    <RadioGroup.Option
                                                        ...
                                                        className={({active, checked}) =>
                                                            cn(
                                                                'relative block cursor-pointer rounded-lg bg-white px-6 py-4 shadow-sm border-2 border-zinc-200 focus:outline-nonering-0 focus:ring-0 outline-none sm:flex sm:justify-between',
                                                                {
                ...
                <div className="w-full px-8 h-16 bg-white">
                    ...
                    items-center">
                        ...
                        items-center">
                            ...
                            whitespace-nowrap">
                                {formatPrice((BASE_PRICE + options.finish.price +
